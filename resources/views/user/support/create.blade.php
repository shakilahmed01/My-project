                    ...
                    <div class="card-body">
                        <form  action="{{route('ticket.store')}}"  method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="text-end">
                                    <button type="button" class="btn grad text-white btn-sm addFile">
                            ...
                            <div class="form-group">
                                <button class="btn grad text-white w-100" type="submit"><i class="fa fa-paper-plane"></i>&nbsp;@lang('Submit')</button>
                            </div>
                        </form>
                    </div>
                </div>
